...
function execGetData (options) {
  ...
  options = options || {};
  var exec = new cSheetExec.SheetExec();
...
function execSetData (options ) {
  ...
  var sheetExec = new cSheetExec.SheetExec().sheetOpen(options.id, options.sheetName);
...
function execMatch (flightNumbers) {
  ...
  // get the sheet data
  var lookup = new cSheetExec.SheetExec()
...
function execLog (results) {
  ...
  // get the sheet data
  var sheetExec = new cSheetExec.SheetExec().sheetOpen(Settings.LOG.ID, Settings.LOG.NAME);
